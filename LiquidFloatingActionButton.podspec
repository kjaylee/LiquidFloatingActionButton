...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.source_files = 'Sources/LiquidFloatingActionButton/Classes/**/*'
  # s.resource_bundles = {
  #   'LiquidFloatingActionButton' => ['Sources/LiquidFloatingActionButton/Assets/*.png']
  # }

  # s.public_header_files = 'Sources/LiquidFloatingActionButton/Classes/**/*.h'
